    ...
    "18e849997856fca4fa6c3f030dbc9ec6": [
        {
            ...
            "controles": {
                "Sugerencias": ["Implementar bandejas de contención para líquidos - Capacitación en bloqueo y etiquetado (LOTO) antes de intervención mecánica."],
    ...
    "33c82313332b2518b6fd74cbf96f4d4e": [
        {
            ...
            "controles": {
                ...
                "EPP": ["Aplicar la Resolución 1409 de 2012 (Colombia): uso obligatorio de arnés de seguridad con línea de vida certificada."]
            }
        }
    ],
    # Imagen: caida2.jpg
    "042cabc55ad406c4066a104082887904": [
        {
            ...
            "tipo": "MECANICO",
            "nombre": "Cortes o pinchazos por contacto con varillas de acero.",
            "descripcion": "Golpes por caída de herramientas desde niveles superiores.",
            "controles": {
                "Sugerencia": ["Capacitación en trabajo seguro en alturas"],
                "Sugerencia 2": ["Supervisión constante del orden en el área de trabajo."],
                "Ingeniería": ["Instalar protecciones perimetrales - Colocar protecciones plásticas o tapas en los extremos de las varillas."],
    ...
    "3467ff21748148900fb78003c5c698ae": [
        {
            ...
            "tipo": "MECANICO",
            "nombre": "Aplastamiento o amputación de dedos.",
            "descripcion": "Cortes con bordes afilados.",
            "controles": {
    ...
    "487c1371f49d60668c2ea42b5e3d4e74": [
        {
            ...
            "tipo": "MECANICO",
            "nombre": "Cortes con elementos de madera o clavos expuestos - Golpes o caídas de herramientas manuales..",
            "controles": {
    ...
    "651c69806e409aa5706756b3cd0a4706": [
        {
            ...
            "tipo": "MECANICO",
            "nombre": "Golpes con herramientas o materiales en altura - Atrapamiento entre andamio y estructura",
            "controles": {
